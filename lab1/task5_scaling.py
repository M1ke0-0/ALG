...
Оценка времени масштабирования

Алгоритм имеет сложность O(n log n).
При n1 = 1 000 000 он срабатывает за T1 = 120 мс.
Оценить время T2 при n2 = 4 000 000.
"""

import math

print("=" * 60)
print("ЗАДАНИЕ 5: Оценка времени масштабирования O(n log n)")
print("=" * 60)
